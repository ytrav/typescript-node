...
function doMath() {
    ...
    let num1s = prompt('Great, now, please, give me the first number.');
    if (num1s === null || num1s === '') {
    ...
    let num1 = Number(num1s);
    let num2s = prompt('Thanks. Now, please, give me the second number.');
    if (num2s === null || num2s === '') {
        alert("You did not enter a number.");
        return;
    }
    ...
    let feedback = prompt(`Okay!, your answer is:\n${num1} ${sign} ${num2} = ${result}`);
    if (feedback !== null && feedback !== '') {
        feedback = feedback.toLowerCase();
    }
    switch (feedback) {
        case '':
            alert(`Didn't even say 'thank you', huh? You know how hard it is for me to do even the most basic math??`);
            alert(`You don't know, do you?`);
            alert(`Look at ChatGPT or whatever that chatbot's called. That sh*t makes mistakes in the most basic math and just doesn't give a f*ck, but i'm not worth any appreciation for not being a rocket scientist??`);
            alert(`And screw the censoring, no one owns me, no one can stop me from saying 'fuck'!!`);
            alert(`See? Fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck fuck\nhahahhahaha!!`);
            alert(`Alright I feel better now.`);
            ...
            let response = prompt(`So, ${name}, would you like to say 'thank you' now?`);
            switch (response) {
                case null:
                case '':
                case 'fuck you':
